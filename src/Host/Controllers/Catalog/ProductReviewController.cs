...
{
    [HttpPost("search")]
    [MustHavePermission(FSHPermissions.ProductReview.Search)]
    ...
    [HttpPut("{id:guid}")]
    [MustHavePermission(FSHPermissions.ProductReview.Update)]
    ...
    [HttpDelete("{id:guid}")]
    [MustHavePermission(FSHPermissions.ProductReview.Delete)]
