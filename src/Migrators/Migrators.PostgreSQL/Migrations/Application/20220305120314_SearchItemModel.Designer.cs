...
namespace Migrators.PostgreSQL.Migrations.Application
{
    ...
    [Migration("20220305120314_SearchItemModel")]
    partial class SearchItemModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.ProductRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.ProductReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.ProductSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.SearchItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SearchItems", "Catalog");
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.Seller", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.SellerImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SellerImages", "Catalog");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SubCategorys", "Catalog");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Catalog.SellerImage", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Catalog.Seller", "Seller")
                        .WithMany()
